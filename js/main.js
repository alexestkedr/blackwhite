...
/* Найти среднее из трех чисел. Сделать проверку на корректность вводимых данных с помощью цикла. Т.е, если пользователь вводит не число, то мы его снова кидаем на ввод данных.
var x = +prompt('Введи 1-ое число');
var y = +prompt('Введи 2-ое число');
var z = +prompt('Введи 3-е число');
var res;
